     ...
     <div className="flex flex-row gap-2 items-center justify-start 2xl:justify-center px-4 py-1 space-x-1.5">
       ...
       {actions.map((item, index) => (
         <Button
           ...
           variant="outline"
           size="sm"
           className="rounded-xl text-xs px-3 py-1.5 h-auto whitespace-nowrap bg-background/50 backdrop-blur-sm border-foreground/40 border-[1.5px] hover:border-foreground hover:bg-foreground/10 transition-all duration-200"
         >
           {item}
         </Button>
       ))}
